...
export function ApplicationCard({ application, taskCount }: ApplicationCardProps) {
  ...
  return (
    <article className="flex h-full flex-col rounded-2xl border-2 border-[var(--border)] bg-white p-6 shadow-sm">
      <div aria-hidden="true" className="mb-4 flex size-16 items-center justify-center rounded-2xl bg-[#e4eee8] text-2xl font-bold text-[var(--primary-dark)]">
      ...
      <p className="mt-4 font-semibold">
        {taskCount} {taskCount === 1 ? "tarefa disponível" : "tarefas disponíveis"}
      </p>
